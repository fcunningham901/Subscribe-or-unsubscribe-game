const express = require('/home/claude/game-server/node_modules/express');
const { WebSocketServer, WebSocket } = require('/home/claude/game-server/node_modules/ws');
const http = require('http');
const path = require('path');
const os = require('os');
const QRCode = require('/home/claude/game-server/node_modules/qrcode');
